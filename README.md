...
### No Database. No Backend. No Data Stored.
...
1.  **Fill Details:** Open the page and enter your Name, UPI ID, and an optional custom title or amount.
2.  **Get Your Link:** Click "Generate Page" to get your unique, shareable link.
3.  **Share Anywhere:** Share your link on social media, your blog, your stream, or anywhere else to get paid.
...
2.  Upload the `index.html`, `donate.html`, and `script.js` files to any static hosting provider (like GitHub Pages or Cloudflare Pages).
3.  That's it! Your version of the tool is live.
